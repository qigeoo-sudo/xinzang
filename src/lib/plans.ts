...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    period: '/月',
    durationDays: 30,
    features: ['60次 AI 导师分身对话', '全部 11 位导师分身解锁', '对话历史云端保存1年'],
    popular: false,
  ...
  },
  {
    ...
    period: '/季',
    durationDays: 90,
    features: ['200次 AI 导师分身对话', '全部 11 位导师分身解锁', '对话历史云端保存3年', '优先体验新功能'],
    popular: true,
  ...
  },
  {
    ...
    period: '/年',
    durationDays: 365,
    features: ['无限次 AI 导师分身对话', '全部 11 位导师分身解锁', '对话历史云端永久保存', '优先体验新功能', '优先开放新导师分身'],
    popular: false,
